...
def generateWrapper(declaration, comment):
    ...
    binding_return_type_declaration = formatParameter(translate_type_for_binding_return(return_type), function_name)
    ...
    fortran_return_type_declaration = formatParameter(translate_type_for_fortran_return(return_type), function_name)
...
!> %(comment)s
    ...
    function %(function_name)s %(parameter_list)s 
     %(use_intrinsic)s
