...
integer, parameter :: ODBQL_IOERR_READ = IOR(ODBQL_IOERR, LSHIFT(1,8)) ! (ODBQL_IOERR | (1<<8)) 
integer, parameter :: ODBQL_IOERR_SHORT_READ = IOR(ODBQL_IOERR, LSHIFT(2,8)) ! (ODBQL_IOERR | (2<<8)) 
integer, parameter :: ODBQL_IOERR_WRITE = IOR(ODBQL_IOERR, LSHIFT(3,8)) ! (ODBQL_IOERR | (3<<8)) 
integer, parameter :: ODBQL_IOERR_FSYNC = IOR(ODBQL_IOERR, LSHIFT(4,8)) ! (ODBQL_IOERR | (4<<8)) 
integer, parameter :: ODBQL_IOERR_DIR_FSYNC = IOR(ODBQL_IOERR, LSHIFT(5,8)) ! (ODBQL_IOERR | (5<<8)) 
integer, parameter :: ODBQL_IOERR_TRUNCATE = IOR(ODBQL_IOERR, LSHIFT(6,8)) ! (ODBQL_IOERR | (6<<8)) 
integer, parameter :: ODBQL_IOERR_FSTAT = IOR(ODBQL_IOERR, LSHIFT(7,8)) ! (ODBQL_IOERR | (7<<8)) 
integer, parameter :: ODBQL_IOERR_UNLOCK = IOR(ODBQL_IOERR, LSHIFT(8,8)) ! (ODBQL_IOERR | (8<<8)) 
integer, parameter :: ODBQL_IOERR_RDLOCK = IOR(ODBQL_IOERR, LSHIFT(9,8)) ! (ODBQL_IOERR | (9<<8)) 
integer, parameter :: ODBQL_IOERR_DELETE = IOR(ODBQL_IOERR, LSHIFT(10,8)) ! (ODBQL_IOERR | (10<<8)) 
integer, parameter :: ODBQL_IOERR_BLOCKED = IOR(ODBQL_IOERR, LSHIFT(11,8)) ! (ODBQL_IOERR | (11<<8)) 
integer, parameter :: ODBQL_IOERR_NOMEM = IOR(ODBQL_IOERR, LSHIFT(12,8)) ! (ODBQL_IOERR | (12<<8)) 
integer, parameter :: ODBQL_IOERR_ACCESS = IOR(ODBQL_IOERR, LSHIFT(13,8)) ! (ODBQL_IOERR | (13<<8)) 
integer, parameter :: ODBQL_IOERR_CHECKRESERVEDLOCK = IOR(ODBQL_IOERR, LSHIFT(14,8)) ! (ODBQL_IOERR | (14<<8)) 
integer, parameter :: ODBQL_IOERR_LOCK = IOR(ODBQL_IOERR, LSHIFT(15,8)) ! (ODBQL_IOERR | (15<<8)) 
integer, parameter :: ODBQL_IOERR_CLOSE = IOR(ODBQL_IOERR, LSHIFT(16,8)) ! (ODBQL_IOERR | (16<<8)) 
integer, parameter :: ODBQL_IOERR_DIR_CLOSE = IOR(ODBQL_IOERR, LSHIFT(17,8)) ! (ODBQL_IOERR | (17<<8)) 
integer, parameter :: ODBQL_IOERR_SHMOPEN = IOR(ODBQL_IOERR, LSHIFT(18,8)) ! (ODBQL_IOERR | (18<<8)) 
integer, parameter :: ODBQL_IOERR_SHMSIZE = IOR(ODBQL_IOERR, LSHIFT(19,8)) ! (ODBQL_IOERR | (19<<8)) 
integer, parameter :: ODBQL_IOERR_SHMLOCK = IOR(ODBQL_IOERR, LSHIFT(20,8)) ! (ODBQL_IOERR | (20<<8)) 
integer, parameter :: ODBQL_IOERR_SHMMAP = IOR(ODBQL_IOERR, LSHIFT(21,8)) ! (ODBQL_IOERR | (21<<8)) 
integer, parameter :: ODBQL_IOERR_SEEK = IOR(ODBQL_IOERR, LSHIFT(22,8)) ! (ODBQL_IOERR | (22<<8)) 
integer, parameter :: ODBQL_IOERR_DELETE_NOENT = IOR(ODBQL_IOERR, LSHIFT(23,8)) ! (ODBQL_IOERR | (23<<8)) 
integer, parameter :: ODBQL_IOERR_MMAP = IOR(ODBQL_IOERR, LSHIFT(24,8)) ! (ODBQL_IOERR | (24<<8)) 
integer, parameter :: ODBQL_IOERR_GETTEMPPATH = IOR(ODBQL_IOERR, LSHIFT(25,8)) ! (ODBQL_IOERR | (25<<8)) 
integer, parameter :: ODBQL_IOERR_CONVPATH = IOR(ODBQL_IOERR, LSHIFT(26,8)) ! (ODBQL_IOERR | (26<<8)) 
integer, parameter :: ODBQL_IOERR_VNODE = IOR(ODBQL_IOERR, LSHIFT(27,8)) ! (ODBQL_IOERR | (27<<8)) 
integer, parameter :: ODBQL_IOERR_AUTH = IOR(ODBQL_IOERR, LSHIFT(28,8)) ! (ODBQL_IOERR | (28<<8)) 
integer, parameter :: ODBQL_LOCKED_SHAREDCACHE = IOR(ODBQL_LOCKED, LSHIFT(1,8)) ! (ODBQL_LOCKED |  (1<<8)) 
integer, parameter :: ODBQL_BUSY_RECOVERY = IOR(ODBQL_BUSY, LSHIFT(1,8)) ! (ODBQL_BUSY   |  (1<<8)) 
integer, parameter :: ODBQL_BUSY_SNAPSHOT = IOR(ODBQL_BUSY, LSHIFT(2,8)) ! (ODBQL_BUSY   |  (2<<8)) 
integer, parameter :: ODBQL_CANTOPEN_NOTEMPDIR = IOR(ODBQL_CANTOPEN, LSHIFT(1,8)) ! (ODBQL_CANTOPEN | (1<<8)) 
integer, parameter :: ODBQL_CANTOPEN_ISDIR = IOR(ODBQL_CANTOPEN, LSHIFT(2,8)) ! (ODBQL_CANTOPEN | (2<<8)) 
integer, parameter :: ODBQL_CANTOPEN_FULLPATH = IOR(ODBQL_CANTOPEN, LSHIFT(3,8)) ! (ODBQL_CANTOPEN | (3<<8)) 
integer, parameter :: ODBQL_CANTOPEN_CONVPATH = IOR(ODBQL_CANTOPEN, LSHIFT(4,8)) ! (ODBQL_CANTOPEN | (4<<8)) 
integer, parameter :: ODBQL_CORRUPT_VTAB = IOR(ODBQL_CORRUPT, LSHIFT(1,8)) ! (ODBQL_CORRUPT | (1<<8)) 
integer, parameter :: ODBQL_READONLY_RECOVERY = IOR(ODBQL_READONLY, LSHIFT(1,8)) ! (ODBQL_READONLY | (1<<8)) 
integer, parameter :: ODBQL_READONLY_CANTLOCK = IOR(ODBQL_READONLY, LSHIFT(2,8)) ! (ODBQL_READONLY | (2<<8)) 
integer, parameter :: ODBQL_READONLY_ROLLBACK = IOR(ODBQL_READONLY, LSHIFT(3,8)) ! (ODBQL_READONLY | (3<<8)) 
integer, parameter :: ODBQL_READONLY_DBMOVED = IOR(ODBQL_READONLY, LSHIFT(4,8)) ! (ODBQL_READONLY | (4<<8)) 
integer, parameter :: ODBQL_ABORT_ROLLBACK = IOR(ODBQL_ABORT, LSHIFT(2,8)) ! (ODBQL_ABORT | (2<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_CHECK = IOR(ODBQL_CONSTRAINT, LSHIFT(1,8)) ! (ODBQL_CONSTRAINT | (1<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_COMMITHOOK = IOR(ODBQL_CONSTRAINT, LSHIFT(2,8)) ! (ODBQL_CONSTRAINT | (2<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_FOREIGNKEY = IOR(ODBQL_CONSTRAINT, LSHIFT(3,8)) ! (ODBQL_CONSTRAINT | (3<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_FUNCTION = IOR(ODBQL_CONSTRAINT, LSHIFT(4,8)) ! (ODBQL_CONSTRAINT | (4<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_NOTNULL = IOR(ODBQL_CONSTRAINT, LSHIFT(5,8)) ! (ODBQL_CONSTRAINT | (5<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_PRIMARYKEY = IOR(ODBQL_CONSTRAINT, LSHIFT(6,8)) ! (ODBQL_CONSTRAINT | (6<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_TRIGGER = IOR(ODBQL_CONSTRAINT, LSHIFT(7,8)) ! (ODBQL_CONSTRAINT | (7<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_UNIQUE = IOR(ODBQL_CONSTRAINT, LSHIFT(8,8)) ! (ODBQL_CONSTRAINT | (8<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_VTAB = IOR(ODBQL_CONSTRAINT, LSHIFT(9,8)) ! (ODBQL_CONSTRAINT | (9<<8)) 
integer, parameter :: ODBQL_CONSTRAINT_ROWID = IOR(ODBQL_CONSTRAINT, LSHIFT(10,8)) ! (ODBQL_CONSTRAINT |(10<<8)) 
integer, parameter :: ODBQL_NOTICE_RECOVER_WAL = IOR(ODBQL_NOTICE, LSHIFT(1,8)) ! (ODBQL_NOTICE | (1<<8)) 
integer, parameter :: ODBQL_NOTICE_RECOVER_ROLLBACK = IOR(ODBQL_NOTICE, LSHIFT(2,8)) ! (ODBQL_NOTICE | (2<<8)) 
integer, parameter :: ODBQL_WARNING_AUTOINDEX = IOR(ODBQL_WARNING, LSHIFT(1,8)) ! (ODBQL_WARNING | (1<<8)) 
integer, parameter :: ODBQL_AUTH_USER = IOR(ODBQL_AUTH, LSHIFT(1,8)) ! (ODBQL_AUTH | (1<<8)) 
