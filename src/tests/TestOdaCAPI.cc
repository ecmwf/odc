...
static int test_odacapi_setup_in_C()
{
...
static int test_odacapi()
{
    ...
    return test_odacapi_setup_in_C()
            || test_odacapi1()
            || test_odacapi2()
            || test_odacapi3();
}
