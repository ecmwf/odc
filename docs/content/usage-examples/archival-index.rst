...
Shown below is a simple program to extract metadata from a sequence of frames to use as an index for archival. The Span API used to extract this information is only available using the C++ and Rust interfaces.
...
.. note::
   ...
   C and Fortran interface do not support a viewport into frame data without decoding it. In this case, recommended API is C++ or Rust.
...
.. tabs::
   ...
   .. group-tab:: Rust
      ...
      .. literalinclude:: ../../../rust/crates/odc/examples/odc_index.rs
         :language: rust
         :class: copybutton
      ...
      .. code-block:: none
         ...
         cargo run --example odc_index -- span.odb

         Archival unit: offset=0 length=345
           Key: key1=1 key2=100 key3=foo
         Archival unit: offset=345 length=345
           Key: key1=2 key2=200 key3=bar
         Archival unit: offset=690 length=412
           Key: key1=3 key2=300 key3=baz
